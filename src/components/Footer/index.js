...
export default function Footer() {
  ...
  return (
    <FooterFrame>
      <FooterElement>
        <Title>
          <Link id="link" href="https://tokenswap.nordicenergy.io/about/">
            <h1 id="title">About</h1>
          </Link>
          <Link id="link" href="https://tokenswap.nordicenergy.io/docs/">
            <h1 id="title">Docs</h1>
          </Link>
          <Link id="link" href="https://github.com/nordicenergy/tokenswap/">>
             <h1 id="title">Code</h1>
          </Link>
        </Title>
      </FooterElement>
