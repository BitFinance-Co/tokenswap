...
const BetaMessage = styled.div`
  ...
  padding-right: 2rem;
  margin-bottom: 1rem;
  border: 1px solid ${({ theme }) => transparentize(0.6, theme.wisteriaOrange)};
  background-color: ${({ theme }) => transparentize(0.9, theme.wisteriaOrange)};
  border-radius: 2rem;
  font-size: 0.75rem;
  line-height: 1rem;
  text-align: left;
  ...
  white-space: nowrap;
  color: ${({ theme }) => theme.wisteriaOrange};
